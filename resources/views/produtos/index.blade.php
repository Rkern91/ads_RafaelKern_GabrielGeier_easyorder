                ...
                <div class="inline-block bg-black text-white border border-white/20 rounded-lg p-5"
                            ...
                            @forelse($produtos as $p)
                                <tr class="border-b border-white/10">
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap">
                                        R$ {{ number_format($p->vl_valor,2,',','.') }}</td>
                                    <td class="px-4 py-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <form method="post" action="{{ route('produtos.destroy', $p) }}"
                                                  class="inline">
                                                @csrf @method('DELETE')
                                                <button data-confirm="Deseja remover este Produto?"
                    ...
                    <div class="mt-5 flex justify-center" style="margin-top:20px;">
                        <a href="{{ route('produtos.create') }}"
                           ...
                           style="color:black;">Novo produto</a>
                    </div>
