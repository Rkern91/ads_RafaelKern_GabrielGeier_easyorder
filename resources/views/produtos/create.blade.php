                ...
                <div class="inline-block text-white border border-white/20 rounded-lg p-6" style="background-color:#0f0f0f; width:100%; max-width:640px;">
                    <form id="formCreateProduto" method="post" action="{{ route('produtos.store') }}" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <select id="cd_categoria" name="cd_categoria" style="color: black;" class="w-full rounded bg-black text-white border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                        ...
                        <div>
                            ...
                            <input id="nm_produto" name="nm_produto" style="color: black;" value="{{ old('nm_produto') }}" class="w-full rounded bg-black text-white placeholder-gray-400 border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                        ...
                        <div>
                            ...
                            <input id="vl_valor" type="number" name="vl_valor" style="color: black;" value="{{ old('vl_valor') }}" step="0.01" min="0" class="w-full rounded bg-black text-white border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                    ...
                    <div class="flex justify-center gap-4 pt-6">
                        <a href="{{ route('produtos.index') }}" style="background-color: gray;" class="px-5 py-2 rounded bg-white text-black hover:opacity-90 transition">Voltar</a>
                        <button type="submit" form="formCreateProduto" style="color: black;" class="px-5 py-2 rounded bg-white text-black hover:opacity-90 transition">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
