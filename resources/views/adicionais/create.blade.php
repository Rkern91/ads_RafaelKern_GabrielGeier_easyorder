        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center">
                <div class="inline-block text-white border border-white/20 rounded-lg p-6" style="background-color:#0f0f0f; width:100%; max-width:640px;">
                    <form id="formCreateAdicional" method="post" action="{{ route('adicionais.store') }}" class="space-y-6" enctype="multipart/form-data">
                        @csrf

                        <div>
                            <label for="nm_adicional" class="block text-sm mb-2 text-white">Nome</label>
                            <input  style="color: black;" id="nm_adicional" name="nm_adicional" value="{{ old('nm_adicional') }}" class="w-full rounded bg-black text-white placeholder-gray-400 border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                        ...
                        <div>
                            ...
                            <input style="color: black;" id="vl_adicional" type="number" step="0.01" min="0" name="vl_adicional" value="{{ old('vl_adicional') }}" class="w-full rounded bg-black text-white border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                        ...
                        <div>
                            ...
                            <input id="ds_adicional" style="color: black;" name="ds_adicional" value="{{ old('ds_adicional') }}" class="w-full rounded bg-black text-white placeholder-gray-400 border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                    ...
                    <div class="flex justify-center gap-4 pt-6">
                        ...
                        <button type="submit" form="formCreateAdicional" class="px-5 py-2 rounded bg-white text-black hover:opacity-90 transition" style="color: black">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
