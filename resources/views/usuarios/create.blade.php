        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center">
                <div class="inline-block text-white border border-white/20 rounded-lg p-6"
                    ...
                    <form id="formCreateUsuario" method="post" action="{{ route('usuarios.store') }}"
                          class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        @csrf

                        <div class="sm:col-span-2 mb-2">
                            <label class="block mb-1 text-sm text-white">Nome</label>
                            <input style="color: black" name="nm_pessoa" value="{{ old('nm_pessoa') }}"
                        ...
                        <div class="sm:col-span-2 mb-2">
                            ...
                            <input style="color: black" name="ds_apelido" value="{{ old('ds_apelido') }}"
                                   class="w-full rounded bg-black text-white placeholder-gray-400 border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                            @error('ds_apelido')
                            <div class="text-sm text-red-400 mt-1">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div class="sm:col-span-2 mb-2">
                            ...
                            <input style="color: black" name="nr_cpf_cnpj" value="{{ old('nr_cpf_cnpj') }}"
                                   maxlength="14"
                        ...
                        <div class="sm:col-span-2 mb-2">
                            ...
                            <input style="color: black" type="email" name="ds_email" value="{{ old('ds_email') }}"
                                   class="w-full rounded bg-black text-white placeholder-gray-400 border border-white/20 focus:border-white/40 focus:ring-0 p-2.5">
                            @error('ds_email')
                            <div class="text-sm text-red-400 mt-1">{{ $message }}</div> @enderror
                        </div>
                    ...
                    <div class="flex justify-center gap-4 pt-6">
                        ...
                        <button type="submit" form="formCreateUsuario"
                                class="px-5 py-2 rounded bg-white text-black hover:opacity-90 transition"
